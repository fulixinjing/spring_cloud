...
$(document).ready(function()
{
    ...
    $("#file_upload").uploadify({
        ...
        'uploader': '${ctx}/user/uploadFile.do;jsessionid=<%=session.getId()%>',
        ...
        'onUploadSuccess' : function(file, data, response) {
            ...
            $.ajax({
        		url:"${ctx}/user/getExcelInfoList.do",
        		data:{
...
<body>
<form id="scoreinfo" action="${ctx}/scoreparam/uploadFile.do" method="post" enctype="multipart/form-data" >
<tags:message content="${message}" type="success" />
<div class="TAB_right">
	<h1><b>位置：</b><a href="###">文件上传</a><span>&gt;</span><a href="###">用户信息上传</a></h1>
