...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#FBEC88","bg_over":"#FFF","bg_out":"#b7d2ff"}
};
...
__ci.document.writeln('select {font-size:12px;}');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#E0ECFF;color:#000;width:24px;}');
...
__ci.document.writeln('td.sat {color:#00ee00;background-color:#FFF;border-radius:3px;}');
__ci.document.writeln('td.sun {color:#CC2222;background-color:#FFF;border-radius:3px;}');
__ci.document.writeln('td.normal {background-color:#fff;border-radius:3px;}');
__ci.document.writeln('input.l {border: 1px solid #c8d4e8;background-color:#EFEFEF;width:20px;height:20px;}');
__ci.document.writeln('input.r {border: 1px solid #c8d4e8;background-color:#EFEFEF;width:20px;height:20px;}');
__ci.document.writeln('input.b {border: 1px solid #c8d4e8;background-color:#EFEFEF;width:100%;height:20px;}');
__ci.document.writeln('-->');
