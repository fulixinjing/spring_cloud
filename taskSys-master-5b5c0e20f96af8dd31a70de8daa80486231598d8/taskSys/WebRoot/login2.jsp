...
<body style="overflow-y: auto;"  onload="loadSubmit()">
...
<div class="header" style="background:#fff;">
          ...
          <div class="sr-box fr mg-t65">
            ...
            <ul class="mg-l29">
              <li class="fn-clear mg-t35">
                <input id="username" name="username" type="text" placeholder="用户名—员工号" value="" onclick="focusMeByAll(this,'');" onblur="blurMeByAll(this,''),validateXml1(this);" maxlength="35" class="fl srk">
              </li>
              <li class="fn-clear mg-t35">
    ...
    <div class="txt-c cgray3" style="margin-top: 15px;">Copyright&nbsp;©&nbsp;2015&nbsp;SR&nbsp;All&nbsp;Rights&nbsp;Reserved&nbsp;</div>
