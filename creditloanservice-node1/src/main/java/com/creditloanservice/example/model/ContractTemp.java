package com.creditloanservice.example.model;

import java.math.BigDecimal;
import java.util.Date;

import com.creditloanservice.common.BaseEntity;
public class ContractTemp  extends BaseEntity{
    private String id;
	...
	public String toString() {
		return "ContractTemp [id=" + id + ", applyId=" + applyId
				+ ", contractCode=" + contractCode + ", loanCode=" + loanCode
				+ ", contractDueDay=" + contractDueDay
				+ ", monthPayTotalAmount=" + monthPayTotalAmount
				+ ", contractFactDay=" + contractFactDay
				+ ", contractReplayDay=" + contractReplayDay
				+ ", contractEndDay=" + contractEndDay + ", classType="
				+ classType + ", productType=" + productType + ", auditAmount="
				+ auditAmount + ", contractMonths=" + contractMonths
				+ ", midId=" + midId + ", dictRepayMethod=" + dictRepayMethod
				+ ", contractAmount=" + contractAmount
				+ ", contractExpectAmount=" + contractExpectAmount
				+ ", contractMonthRepayAmount=" + contractMonthRepayAmount
				+ ", dictCheckStatus=" + dictCheckStatus
				+ ", contractBackResult=" + contractBackResult
				+ ", contractVersion=" + contractVersion + ", createBy="
				+ createBy + ", createTime=" + createTime + ", modifyBy="
				+ modifyBy + ", modifyTime=" + modifyTime + ", docId=" + docId
				+ ", auditCount=" + auditCount + ", backFlag=" + backFlag
				+ ", isobsolete=" + isobsolete + ", coboName=" + coboName
				+ ", coboCertNum=" + coboCertNum + ", loanName=" + loanName
				+ ", loanCertNum=" + loanCertNum + ", channelFlag="
				+ channelFlag + ", contractMonthRepayTotal="
				+ contractMonthRepayTotal + ", companyName=" + companyName
				+ ", legalMan=" + legalMan + ", maddress=" + maddress
				+ ", model=" + model + ", isRegister=" + isRegister
				+ ", paperLessFlag=" + paperLessFlag + ", settleCause="
				+ settleCause + ", settleCauseElse=" + settleCauseElse
				+ ", protocolId=" + protocolId + ", dictSourceType="
				+ dictSourceType + ", dictSourceTypePcl=" + dictSourceTypePcl
				+ ", creditId=" + creditId + ", contractHistoryVersion="
				+ contractHistoryVersion + ", revisitStatus=" + revisitStatus
				+ ", revisitReason=" + revisitReason + ", pushTime=" + pushTime
				+ ", pushNumber=" + pushNumber + ", auditingBy=" + auditingBy
				+ ", auditingTime=" + auditingTime + ", lender=" + lender
				+ ", newFlag=" + newFlag + ", feePaymentAmount="
				+ feePaymentAmount + ", isreceive=" + isreceive
				+ ", feeAllRaio=" + feeAllRaio + ", signUpFlag=" + signUpFlag
				+ "]";
	}
