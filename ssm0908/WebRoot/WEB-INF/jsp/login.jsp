          ...
          <div class="sr-box fr mg-t65">
            ...
            <ul class="mg-l29">
              <li class="fn-clear mg-t35">
                <input id="username" name="username" type="text" placeholder="用户名" value="" onclick="focusMeByAll(this,'');" onblur="blurMeByAll(this,''),validateXml1(this);" maxlength="35" class="fl srk">
              </li>
              <li class="fn-clear mg-t35">
